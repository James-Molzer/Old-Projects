...
namespace TenmoServer.Controllers
{
    ...
    public class AccountController : ControllerBase
    {
        ...
        public ActionResult<List<Transfer>> transferTEMoney(Transfer transfer)
        {
            Transfer newtransfer = _transferDAO.GetTransactions(transfer);
            _accountDAO.UpdatedBalance(transfer.AccountFrom, -transfer.Amount);
            _accountDAO.UpdatedBalance(transfer.AccountTo, transfer.Amount);
